...
current_dir = "E:\Measurement\Reflectivity"
...
file = open(sample + '_Wavelength_sweep_' + str(wavelength) + '_to_' + str(wavelength_f) + '_step' + str(step) + str(today) +'.txt', "w")
...
plt.savefig(sample + '_Wavelength_sweep_' + str(wavelength) + '_to_' + str(wavelength_f) + '_step' + str(step) + str(today)+ '.png')
plt.close()
plt.plot(wavelength_array[1:], np.divide(data, data2)[1:], 'b-o')
plt.xlabel('Wavelength [nm]')
plt.ylabel('Reflectivity')
plt.savefig(sample + '_Reflectivity_' + str(wavelength) + '_to_' + str(wavelength_f) + '_step' + str(step) + str(today) + '.png')
plt.show()
plt.close()
